...
function ComonTable({created_date, buyer,order_id, email, phone, booking_date, booking_time, total_fees, status, id, product_order_details }) {
  ...
  return (
    ...
    <>
      ...
      <Modal show={show1} onHide={handleClose1}>
        ...
        <Modal.Body>
          <strong>Do you want to reject the order?</strong>
      ...
      <Modal show={show2} onHide={handleClose2}>
        ...
        <Modal.Body>
          <strong>Do you want to approve the order?</strong>
      ...
      <tr>
        ...
        <td>
          <CCol col="6" sm="4" md="2" xl className="mb-3 mb-xl-0">
            <a className="btn btn-danger" style={{ margin: "5px", color: "white",paddingRight:"20px",paddingLeft:"20px" }} onClick={handleShow1} >

              Reject
           </a>
            <a className="btn btn-success" style={{ margin: "5px", color: "white" }} onClick={handleShow2}>Approve</a>
          </CCol>
        </td>
        ...
        <td>
          <CCol col="6" sm="4" md="2" xl className="mb-3 mb-xl-0">
            ...
            <a style={{color:"white"}} className="btn btn-primary" onClick={handleShow}>
              Details
      </a>
