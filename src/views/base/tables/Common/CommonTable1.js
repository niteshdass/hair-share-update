...
toast.configure()
function ComonTable1({created_date,buyer,order_id,email,phone,booking_date,booking_time,total_fees,status,id,product_order_details}) {
