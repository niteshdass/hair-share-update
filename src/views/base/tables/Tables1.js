...
import CommonTable1 from './Common/CommonTable1'
...
const Tables1 = () => {
 ...
 const handleChange = value => {
  ...
  function getNewOrder (){
    ...
    db.collection("allOrderList").where('product_order.status', '==', "accepted").orderBy("product_order.last_update").onSnapshot(function(querySnapshot){
      setNewOrder(
